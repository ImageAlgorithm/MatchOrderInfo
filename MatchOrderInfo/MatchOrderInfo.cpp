...
void ProcessResult(string strSrcResult, string img_path)
{
	...
	{
		//当前截图为QQ截图
		string g_str1 = "商户订单";		// 商户订单
		string g_str2 = "修改密码";		// 修改密码
		string g_str3 = "金额";			// 金额
		string g_str4 = "订单金额";		// 订单金额
		string g_str5 = "商品";			// 商品
		...
		nIndex1 = (int)strSrcResult.find(g_str3);	//“金额”的位置
		nIndex2 = (int)strSrcResult.find(g_str4);	//“订单金额”的位置
		if (nIndex2 < 0)
		{
			nIndex2 = (int)strSrcResult.find(g_str5); // “商品”的位置
		}
		string strMoney = "";	//金额
	...
	{
		//截图为微信图片
		string g_str1 = "商户单号";	// 商户单号
		string g_str2 = "在此商户";	// 在此商户
		string g_str3 = "充值服务";
		string g_str4 = "当前状态";
